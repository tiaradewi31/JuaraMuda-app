  ...
  <div class="container">
    ...
    @csrf
      <div class="mb-3" style="color: #F6E7C0;">
        ...
        <input class="form-control" name="title" id="title" placeholder="Masukkan Program Beasiswa" value="{{ old('title') }}" required>
      ...
      <div class="mb-3">
        <label for="beasiswa" class="form-label" style="color: #F6E7C0;">Detail Beasiswa</label>
        <textarea class="form-control" rows="10" id="beasiswa" input="beasiswa"  placeholder="Masukan Persyaratan, Tanggal Pelaksanaan dan Alur Pendaftaran" name="beasiswa" value="{{ old('beasiswa') }}" require></textarea>
      </div>
