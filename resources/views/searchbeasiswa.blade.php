...
<html lang="en">
  <head>
    ...
    <title>JuaraMuda | Cari Beasiswa!</title>
    </head>
    <style>
      body{
        ...
        <div class="text-center" style="color: white; margin-top: 50px; padding-top: 30px; font-family: 'Poppins', Sans-serif; src: url(https://fonts.google.com/specimen/Poppins?query=Poppins);">
         <h3><b>CARI BEASISWA YUK!</b>
            ...
            <div>
                ...
                <input class="form-control me-2" href type="search" name="Keyword" placeholder="Mau daftar beasiswa apa?"></input>
                ...
                <div class="row g-0">
                  ...
                  <div class="col-md-8">
                    <div class="card-body"  style="color: white;">
                      ...
                      <a href="/searchbeasiswa/{{ $post->slug }}">Baca Selengkapnya</a>
                    </div>
                  </div>
                </div>
              </div>
